...
$query = $conn->query("SELECT * FROM surveyor WHERE id_surveyor = '$id_surveyor'");
...
<head>
    <meta charset="UTF-8">
    <title>SIP-BANTU TANI - Edit Profil</title>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="header-section">
                <h1 class="page-title">
                    <a href="surveyor_profil.php" style="color: #0d7839; text-decoration: none;"><span class="material-symbols-outlined">arrow_back</span></a>
                    Edit Profil
                </h1>
            </div>
            
            <div class="form-box-container">
                <form action="proses_edit_surveyor.php" method="POST">
                    ...
                    <div class="btn-row">
                        <a href="surveyor_profil.php" class="btn-action btn-cancel">Batal</a>
