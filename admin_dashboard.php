...
// Fungsi bantu untuk mengubah format tanggal ke teks Indonesia
...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .stats-grid { display: flex; gap: 30px; margin-bottom: 40px; max-width: 600px; }
        ...
        /* TABLE SECTION - DI-SCROLL */
        .table-section { display: flex; flex-direction: column; gap: 15px; flex-grow: 1; overflow: hidden; }
        .section-title { color: #6c757d; font-size: 14px; font-weight: bold; text-align: center; margin-bottom: 5px; }
        .data-table-container { width: 100%; border: 1px solid #dee2e6; border-radius: 8px; overflow-y: auto; flex-grow: 1; }
        .data-table { width: 100%; border-collapse: collapse; text-align: left; font-size: 14px; }
        .data-table thead th { position: sticky; top: 0; background-color: #e9ecef; color: #495057; padding: 14px 16px; font-weight: bold; z-index: 1; }
        ...
        <main class="main-content">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-icon-box"><span class="material-symbols-outlined">group</span></div>
                </div>
                <div class="stat-card">
                    <div class="stat-info">
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            if (mysqli_num_rows($query_terbaru) > 0) {
                                ...
                                <tr><td colspan="4" class="text-center" style="color: #6c757d; font-style: italic;">Belum ada data pengajuan.</td></tr>
                            <?php } ?>
                        </tbody>
                    </table>
                </div>
