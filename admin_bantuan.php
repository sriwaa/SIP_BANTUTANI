...
// 2. QUERY AMBIL DATA JENIS BANTUAN (SINKRON: Menambahkan kolom deskripsi)
...
<head>
    ...
    <style>
        * {
        ...
        body {
            background-color: #fbc02d; /* Latar belakang kuning figma */
            display: flex;
        ...
        .btn-tambah-bantuan {
            ...
            align-items: center;
            gap: 8px;
            box-shadow: 0 4px 10px rgba(19, 168, 81, 0.15);
            transition: background 0.2s;
        }

        .btn-tambah-bantuan:hover { background-color: #0f8a42; }
        .sub-header-text { color: #6c757d; font-size: 16px; font-weight: 500; margin-top: 20px; margin-bottom: 20px; }

        /* LIST ITEM SEPERTI FIGMA */
        .bantuan-list-wrapper {
            display: flex;
            flex-direction: column;
            gap: 15px;
        }
        ...
        .bantuan-list-item {
            ...
            border-radius: 12px;
            background-color: #e2f3e9; /* Latar item hijau muda di figma */
            padding: 15px 25px;
            display: flex;
            align-items: center;
            justify-content: space-between;
        ...
        /* Deskripsi dinamis/fallback jika kosong di DB */
        ...
        .btn-detail-item:hover { background-color: #0f8a42; }
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <a href="admin_bantuan.php" class="menu-item active">
            ...
            <div class="bantuan-list-wrapper">
                ...
                if ($result && $result->num_rows > 0):
                    while ($row = $result->fetch_assoc()): 
                        // MODIFIKASI: Ambil dari DB. Jika teks di DB kosong/null, baru gunakan teks fallback ini.
                    ...
                    <div class="bantuan-list-item">
                        <div class="item-left-side">
                            <div class="item-img-box">
                                <img src="<?= htmlspecialchars($row['gambar']); ?>" alt="<?= htmlspecialchars($row['nama_bantuan']); ?>">
                            </div>
                        ...
                        <div>
                            <a href="admin_detailbantuan.php?id=<?= $row['id']; ?>" class="btn-detail-item">Detail</a>
                        </div>
                    </div>
                <?php 
                    endwhile; 
