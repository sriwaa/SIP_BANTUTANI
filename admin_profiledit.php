...
// Mengambil data admin (Contoh: ID 1)
$id_admin = 1; 
...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        /* Sidebar Branding (Sesuai kode WPDetail) */
            ...
            <div class="form-box-container">
                <form action="proses_edit_profil.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" value="M. Khamdan Azkiya" required>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" name="email" value="khamdan123@gmail.com" required>
                    </div>
                    <div class="form-group">
                        <label>No. HP</label>
                        <input type="text" name="hp" value="0821345678910" required>
                    </div>
